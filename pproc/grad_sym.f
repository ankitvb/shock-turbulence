...
*         d y     d z
      ...
      Call DFDY_sym(U(1,1,1,3), duz_dy, 0, 1.0D0)
      Call DFDZ_sym(U(1,1,1,2), duy_dz, 0, 1.0D0)
...
*         d z     d x
      ...
      Call DFDX_sym(U(1,1,1,3), duz_dx, 0, 1.0D0)
      Call DFDZ_sym(U(1,1,1,1), dux_dz, 0, 1.0D0)
...
*         d x     d y
      ...
      Call DFDX_sym(U(1,1,1,2), duy_dx, 0, 1.0D0)
      Call DFDY_sym(U(1,1,1,1), dux_dy, 0, 1.0D0)
...
*         d x     d y     d z
      ...
      Call DFDX_asym(U(1,1,1,1), dux_dx, 0, 1.0D0)
      Call DFDY_asym(U(1,1,1,2), duy_dy, 0, 1.0D0)
      Call DFDZ_asym(U(1,1,1,3), duz_dz, 0, 1.0D0)
...
************************************************************************
      ...
      Call DFDX_sym(F, Fgrad(1,1,1,1), 0, 1D0)
      Call DFDY_sym(F, Fgrad(1,1,1,2), 0, 1D0)
      Call DFDZ_sym(F, Fgrad(1,1,1,3), 0, 1D0)
