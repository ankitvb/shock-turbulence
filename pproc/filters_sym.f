...
*  x-filter
      Do N = 1,LotX
       Do I = 1,Mx
        ldu_filt_x_sym_A(N,I) =  beta_filt4
        ldu_filt_x_sym_B(N,I) = alpha_filt4
        ldu_filt_x_sym_C(N,I) =       1.0D0
        ldu_filt_x_sym_D(N,I) = alpha_filt4
        ldu_filt_x_sym_E(N,I) =  beta_filt4
       End Do
      End Do
...
*  y-filter
      Do N = 1,LotY      
       Do J = 1,My
        ldu_filt_y_sym_A(N,J) =  beta_filt4
        ldu_filt_y_sym_B(N,J) = alpha_filt4
        ldu_filt_y_sym_C(N,J) =       1.0D0
        ldu_filt_y_sym_D(N,J) = alpha_filt4
        ldu_filt_y_sym_E(N,J) =  beta_filt4
       End Do
      End Do
...
*  z-filter
      Do N = 1,LotZ
       Do K = 1,Mz
        ldu_filt_z_sym_A(N,K) =  beta_filt4
        ldu_filt_z_sym_B(N,K) = alpha_filt4
        ldu_filt_z_sym_C(N,K) =       1.0D0
        ldu_filt_z_sym_D(N,K) = alpha_filt4
        ldu_filt_z_sym_E(N,K) =  beta_filt4
       End Do
      End Do
...
*     
      if(xrank .EQ. 0)then
       Do N = 1,LotX             
        ldu_filt_x_sym_A(N,1) = 0.0D0
        ldu_filt_x_sym_B(N,1) = 0.0D0 
        ldu_filt_x_sym_C(N,1) = 1.0D0
        ldu_filt_x_sym_D(N,1) = 2.0D0 * alpha_filt4
        ldu_filt_x_sym_E(N,1) = 2.0D0 * beta_filt4
       End Do
      endif

      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_filt_x_sym_A(N,Mx) = 0.0D0
        ldu_filt_x_sym_B(N,Mx) = 0.0D0
        ldu_filt_x_sym_C(N,Mx) = 1.0D0
        ldu_filt_x_sym_D(N,Mx) = 0.0D0
        ldu_filt_x_sym_E(N,Mx) = 0.0D0
      ...
      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ldu_filt_y_sym_A(N,1) = 0.0D0
        ldu_filt_y_sym_B(N,1) = 0.0D0
        ldu_filt_y_sym_C(N,1) = 1.0D0
        ldu_filt_y_sym_D(N,1) = 2.0D0 * alpha_filt4
        ldu_filt_y_sym_E(N,1) = 2.0D0 * beta_filt4
       End Do
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_filt_y_sym_A(N,My) = 0.0D0
        ldu_filt_y_sym_B(N,My) = 0.0D0
        ldu_filt_y_sym_C(N,My) = 1.0D0
        ldu_filt_y_sym_D(N,My) = 0.0D0
        ldu_filt_y_sym_E(N,My) = 0.0D0
       End Do
      endif

      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ldu_filt_z_sym_A(N,1) = 0.0D0
        ldu_filt_z_sym_B(N,1) = 0.0D0
        ldu_filt_z_sym_C(N,1) = 1.0D0
        ldu_filt_z_sym_D(N,1) = 2.0D0 * alpha_filt4
        ldu_filt_z_sym_E(N,1) = 2.0D0 * beta_filt4
       End Do
      endif
 
      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_filt_z_sym_A(N,Mz) = 0.0D0
        ldu_filt_z_sym_B(N,Mz) = 0.0D0
        ldu_filt_z_sym_C(N,Mz) = 1.0D0
        ldu_filt_z_sym_D(N,Mz) = 0.0D0
        ldu_filt_z_sym_E(N,Mz) = 0.0D0
       End Do
      endif
...
*       b = a
      ...
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ldu_filt_x_sym_A(N,2)     = 0.0D0
        ldu_filt_x_sym_B(N,2)     = alpha_filt4
        ldu_filt_x_sym_C(N,2)     = 1.0D0 + beta_filt4
        ldu_filt_x_sym_D(N,2)     = alpha_filt4
        ldu_filt_x_sym_E(N,2)     = beta_filt4
       End Do
      endif

      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_filt_x_sym_A(N,Mx-1)     = 0.0D0
        ldu_filt_x_sym_B(N,Mx-1)     = bndy_alpha_filt
        ldu_filt_x_sym_C(N,Mx-1)     = 1.0D0
        ldu_filt_x_sym_D(N,Mx-1)     = bndy_alpha_filt
        ldu_filt_x_sym_E(N,Mx-1)     = 0.0D0
       End Do
      endif

      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ldu_filt_y_sym_A(N,2)     = 0.0D0
        ldu_filt_y_sym_B(N,2)     = alpha_filt4
        ldu_filt_y_sym_C(N,2)     = 1.0D0 + beta_filt4
        ldu_filt_y_sym_D(N,2)     = alpha_filt4
        ldu_filt_y_sym_E(N,2)     = beta_filt4
       End Do 
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_filt_y_sym_A(N,My-1)     = 0.0D0
        ldu_filt_y_sym_B(N,My-1)     = bndy_alpha_filt
        ldu_filt_y_sym_C(N,My-1)     = 1.0D0
        ldu_filt_y_sym_D(N,My-1)     = bndy_alpha_filt
        ldu_filt_y_sym_E(N,My-1)     = 0.0D0
       End Do
      endif

      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ldu_filt_z_sym_A(N,2)     = 0.0D0
        ldu_filt_z_sym_B(N,2)     = alpha_filt4
        ldu_filt_z_sym_C(N,2)     = 1.0D0 + beta_filt4
        ldu_filt_z_sym_D(N,2)     = alpha_filt4
        ldu_filt_z_sym_E(N,2)     = beta_filt4
       End Do
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_filt_z_sym_A(N,Mz-1)     = 0.0D0
        ldu_filt_z_sym_B(N,Mz-1)     = bndy_alpha_filt
        ldu_filt_z_sym_C(N,Mz-1)     = 1.0D0
        ldu_filt_z_sym_D(N,Mz-1)     = bndy_alpha_filt
        ldu_filt_z_sym_E(N,Mz-1)     = 0.0D0
       End Do
      endif
...
*    c = (1 / 8) * (-1 + 2 * bndy_alpha_filt)
      ...
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ldu_filt_x_sym_A(N,3)     = beta_filt4
        ldu_filt_x_sym_B(N,3)     = alpha_filt4
        ldu_filt_x_sym_C(N,3)     = 1.0D0
        ldu_filt_x_sym_D(N,3)     = alpha_filt4
        ldu_filt_x_sym_E(N,3)     = beta_filt4
       End Do
      endif

      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_filt_x_sym_A(N,Mx-2)     = 0.0D0
        ldu_filt_x_sym_B(N,Mx-2)     = bndy_alpha_filt
        ldu_filt_x_sym_C(N,Mx-2)     = 1.0D0
        ldu_filt_x_sym_D(N,Mx-2)     = bndy_alpha_filt
        ldu_filt_x_sym_E(N,Mx-2)     = 0.0D0
       End Do
      endif

      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ldu_filt_y_sym_A(N,3)     = beta_filt4
        ldu_filt_y_sym_B(N,3)     = alpha_filt4
        ldu_filt_y_sym_C(N,3)     = 1.0D0
        ldu_filt_y_sym_D(N,3)     = alpha_filt4
        ldu_filt_y_sym_E(N,3)     = beta_filt4
       End Do
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_filt_y_sym_A(N,My-2)     = 0.0D0
        ldu_filt_y_sym_B(N,My-2)     = bndy_alpha_filt
        ldu_filt_y_sym_C(N,My-2)     = 1.0D0
        ldu_filt_y_sym_D(N,My-2)     = bndy_alpha_filt
        ldu_filt_y_sym_E(N,My-2)     = 0.0D0
       End Do 
      endif

      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ldu_filt_z_sym_A(N,3)     = beta_filt4
        ldu_filt_z_sym_B(N,3)     = alpha_filt4
        ldu_filt_z_sym_C(N,3)     = 1.0D0
        ldu_filt_z_sym_D(N,3)     = alpha_filt4
        ldu_filt_z_sym_E(N,3)     = beta_filt4
       End Do
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_filt_z_sym_A(N,Mz-2)     = 0.0D0
        ldu_filt_z_sym_B(N,Mz-2)     = bndy_alpha_filt
        ldu_filt_z_sym_C(N,Mz-2)     = 1.0D0
        ldu_filt_z_sym_D(N,Mz-2)     = bndy_alpha_filt
        ldu_filt_z_sym_E(N,Mz-2)     = 0.0D0
       End Do
      endif
...
*    d = (1 / 32) * (1  - 2  * alpha_filt4 + 2  * beta_filt4)
      ...
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ldu_filt_x_sym_A(N,4)  =  beta_filt4 
        ldu_filt_x_sym_B(N,4)  = alpha_filt4
        ldu_filt_x_sym_C(N,4)  =       1.0D0
        ldu_filt_x_sym_D(N,4)  = alpha_filt4
        ldu_filt_x_sym_E(N,4)  =  beta_filt4
       End Do
      endif

      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_filt_x_sym_A(N,Mx-3)  =  beta_filt4
        ldu_filt_x_sym_B(N,Mx-3)  = alpha_filt4
        ldu_filt_x_sym_C(N,Mx-3)  =       1.0D0
        ldu_filt_x_sym_D(N,Mx-3)  = alpha_filt4
        ldu_filt_x_sym_E(N,Mx-3)  =  beta_filt4
       End Do
      endif

      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ldu_filt_y_sym_A(N,4)  =  beta_filt4
        ldu_filt_y_sym_B(N,4)  = alpha_filt4
        ldu_filt_y_sym_C(N,4)  =       1.0D0
        ldu_filt_y_sym_D(N,4)  = alpha_filt4
        ldu_filt_y_sym_E(N,4)  =  beta_filt4
       End Do
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_filt_y_sym_A(N,My-3)  =  beta_filt4
        ldu_filt_y_sym_B(N,My-3)  = alpha_filt4
        ldu_filt_y_sym_C(N,My-3)  =       1.0D0
        ldu_filt_y_sym_D(N,My-3)  = alpha_filt4
        ldu_filt_y_sym_E(N,My-3)  =  beta_filt4
       End Do 
      endif

      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ldu_filt_z_sym_A(N,4)  =  beta_filt4
        ldu_filt_z_sym_B(N,4)  = alpha_filt4
        ldu_filt_z_sym_C(N,4)  =       1.0D0
        ldu_filt_z_sym_D(N,4)  = alpha_filt4
        ldu_filt_z_sym_E(N,4)  =  beta_filt4
       End Do 
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_filt_z_sym_A(N,Mz-3)  =  beta_filt4
        ldu_filt_z_sym_B(N,Mz-3)  = alpha_filt4
        ldu_filt_z_sym_C(N,Mz-3)  =       1.0D0
        ldu_filt_z_sym_D(N,Mz-3)  = alpha_filt4
        ldu_filt_z_sym_E(N,Mz-3)  =  beta_filt4
       End Do
      endif
...
*  Filter in X, Y & Z
         if(L .EQ. 1) then
           Call Compact_Filter_X_asym(F(1,1,1,L), F0(1,1,1,L))
         else
           Call Compact_Filter_X_sym(F(1,1,1,L), F0(1,1,1,L))
         endif

         if(L .EQ. 2) then
           Call Compact_Filter_Y_asym(F0(1,1,1,L), F0(1,1,1,L))
         else
           Call Compact_Filter_Y_sym(F0(1,1,1,L), F0(1,1,1,L))
         endif
         if(L .EQ. 3) then
           Call Compact_Filter_Z_asym(F0(1,1,1,L), F0(1,1,1,L))
         else
           Call Compact_Filter_Z_sym(F0(1,1,1,L), F0(1,1,1,L))
         endif
...
*********************************************************************
      Subroutine Compact_Filter_X_sym(F, F0)
...
*  Wait to recieve planes
      ...
      Do J = 1, My
        Do K = 1, Mz
          ...
          if(xrank .EQ. 0)then
           W(N,1) =  a4_filt4 * ( 2D0 * F(J,K,5) )
     .             + a3_filt4 * ( 2D0 * F(J,K,4) )
     .             + a2_filt4 * ( 2D0 * F(J,K,3) )
     .             + a1_filt4 * ( 2D0 * F(J,K,2) )
     .             + a0_filt4 *   F(J,K,1)
 
           W(N,2) =  a4_filt4 * ( F(J,K,4) + F(J,K,6) )
     .             + a3_filt4 * ( F(J,K,3) + F(J,K,5) )
     .             + a2_filt4 * ( F(J,K,2) + F(J,K,4) )
     .             + a1_filt4 * ( F(J,K,1) + F(J,K,3) )
     .             + a0_filt4 *   F(J,K,2)
  
           W(N,3) =  a4_filt4 * ( F(J,K,3) + F(J,K,7) )
     .             + a3_filt4 * ( F(J,K,2) + F(J,K,6) )
     .             + a2_filt4 * ( F(J,K,1) + F(J,K,5) )
     .             + a1_filt4 * ( F(J,K,2) + F(J,K,4) )
     .             + a0_filt4 *   F(J,K,3)

           W(N,4) =  a4_filt4 * ( F(J,K,2) + F(J,K,8) )
...
*  Solve the matrix system to obtain the derivative dF
      Call pentadiagonal(ldu_filt_x_sym_A, ldu_filt_x_sym_B, 
     .                   ldu_filt_x_sym_C, ldu_filt_x_sym_D,
     .                   ldu_filt_x_sym_E, W,
...
*******************************************************************
      Subroutine Compact_Filter_Y_sym(F, F0)
...
*  Wait to recieve planes
      ...
      Do I = 1, Mx
        Do K = 1, Mz
          ...
          if(yrank .EQ. 0)then
           W(N,1) =  a4_filt4 * ( 2D0 * F(5,K,I) )
     .             + a3_filt4 * ( 2D0 * F(4,K,I) )
     .             + a2_filt4 * ( 2D0 * F(3,K,I) )
     .             + a1_filt4 * ( 2D0 * F(2,K,I) )
     .             + a0_filt4 *   F(1,K,I)

           W(N,2) =  a4_filt4 * ( F(4,K,I) + F(6,K,I) )
     .             + a3_filt4 * ( F(3,K,I) + F(5,K,I) )
     .             + a2_filt4 * ( F(2,K,I) + F(4,K,I) )
     .             + a1_filt4 * ( F(1,K,I) + F(3,K,I) )
     .             + a0_filt4 *   F(2,K,I)

           W(N,3) =  a4_filt4 * ( F(3,K,I) + F(7,K,I) )
     .             + a3_filt4 * ( F(2,K,I) + F(6,K,I) )
     .             + a2_filt4 * ( F(1,K,I) + F(5,K,I) )
     .             + a1_filt4 * ( F(2,K,I) + F(4,K,I) )
     .             + a0_filt4 *   F(3,K,I)

           W(N,4) =  a4_filt4 * ( F(2,K,I) + F(8,K,I) )
...
*  Solve the matrix system to obtain the derivative dF
      Call pentadiagonal(ldu_filt_y_sym_A, ldu_filt_y_sym_B, 
     .                   ldu_filt_y_sym_C, ldu_filt_y_sym_D,
     .                   ldu_filt_y_sym_E, W,
...
******************************************************************
      Subroutine Compact_Filter_Z_sym(F, F0)
...
*  Wait to recieve planes
      ...
      Do I = 1, Mx
        Do J = 1, My
          ...
          if(zrank .EQ. 0)then
           W(N,1) = a4_filt4 * ( 2D0 * F(J,5,I) )
     .            + a3_filt4 * ( 2D0 * F(J,4,I) )
     .            + a2_filt4 * ( 2D0 * F(J,3,I) )
     .            + a1_filt4 * ( 2D0 * F(J,2,I) )
     .            + a0_filt4 *   F(J,1,I)

           W(N,2) = a4_filt4 * ( F(J,4,I) + F(J,6,I) )
     .            + a3_filt4 * ( F(J,3,I) + F(J,5,I) )
     .            + a2_filt4 * ( F(J,2,I) + F(J,4,I) )
     .            + a1_filt4 * ( F(J,1,I) + F(J,3,I) )
     .            + a0_filt4 *   F(J,2,I)

           W(N,3) = a4_filt4 * ( F(J,3,I) + F(J,7,I) )
     .            + a3_filt4 * ( F(J,2,I) + F(J,6,I) )
     .            + a2_filt4 * ( F(J,1,I) + F(J,5,I) )
     .            + a1_filt4 * ( F(J,2,I) + F(J,4,I) )
     .            + a0_filt4 *   F(J,3,I)

           W(N,4) = a4_filt4 * ( F(J,2,I) + F(J,8,I) )
...
*  Solve the matrix system to obtain the derivative dF
      Call pentadiagonal(ldu_filt_z_sym_A, ldu_filt_z_sym_B,
     .                   ldu_filt_z_sym_C, ldu_filt_z_sym_D,
     .                   ldu_filt_z_sym_E, W,
...
* No filter at exit boundary
      if(xrank .EQ. Px-1)then
       Do J = 1, My
         Do K = 1, Mz
           Do I = 1, 4
             Fg(J,K,Mx-I+1) = F(J,K,Mx-I+1)
           End Do
         End Do
       End Do
      endif
