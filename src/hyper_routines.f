...
c      Call DFDX(U(1,1,1,1), Sij(1,1,1,1), 0, 1D0)
c      Call DFDX(U(1,1,1,2), Sij(1,1,1,4), 0, 1D0)
c      Call DFDX(U(1,1,1,3), Sij(1,1,1,7), 0, 1D0)

c      Call DFDY(U(1,1,1,1), Sij(1,1,1,2), 0, 1D0)
c      Call DFDY(U(1,1,1,2), Sij(1,1,1,5), 0, 1D0)
c      Call DFDY(U(1,1,1,3), Sij(1,1,1,8), 0, 1D0)

c      Call DFDZ(U(1,1,1,1), Sij(1,1,1,3), 0, 1D0)
c      Call DFDZ(U(1,1,1,2), Sij(1,1,1,6), 0, 1D0)
c      Call DFDZ(U(1,1,1,3), Sij(1,1,1,9), 0, 1D0)
