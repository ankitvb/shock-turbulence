...
*
*  The nodes are eighth order accurate
*
...
*
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ldu_filt_x_A(N,1) = 0.0D0
        ldu_filt_x_B(N,1) = 0.0D0
        ldu_filt_x_C(N,1) = 1.0D0
        ldu_filt_x_D(N,1) = 0.0D0
        ldu_filt_x_E(N,1) = 0.0D0
       End Do
      endif

      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_filt_x_A(N,Mx) = 0.0D0
        ldu_filt_x_B(N,Mx) = 0.0D0
        ldu_filt_x_C(N,Mx) = 1.0D0
        ldu_filt_x_D(N,Mx) = 0.0D0
        ldu_filt_x_E(N,Mx) = 0.0D0
       End Do
      endif

      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ldu_filt_y_A(N,1) = 0.0D0
        ldu_filt_y_B(N,1) = 0.0D0
        ldu_filt_y_C(N,1) = 1.0D0
        ldu_filt_y_D(N,1) = 0.0D0
        ldu_filt_y_E(N,1) = 0.0D0
       End Do
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_filt_y_A(N,My) = 0.0D0
        ldu_filt_y_B(N,My) = 0.0D0
        ldu_filt_y_C(N,My) = 1.0D0
        ldu_filt_y_D(N,My) = 0.0D0
        ldu_filt_y_E(N,My) = 0.0D0
       End Do
      endif
 
      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ldu_filt_z_A(N,1) = 0.0D0
        ldu_filt_z_B(N,1) = 0.0D0
        ldu_filt_z_C(N,1) = 1.0D0
        ldu_filt_z_D(N,1) = 0.0D0
        ldu_filt_z_E(N,1) = 0.0D0
       End Do
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_filt_z_A(N,Mz) = 0.0D0
        ldu_filt_z_B(N,Mz) = 0.0D0
        ldu_filt_z_C(N,Mz) = 1.0D0
        ldu_filt_z_D(N,Mz) = 0.0D0
        ldu_filt_z_E(N,Mz) = 0.0D0
       End Do
      endif

*  The second and second to last nodes use one-sided stencils 
...
*       b = a
      ...
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ldu_filt_x_A(N,2) = 0.0D0
        ldu_filt_x_B(N,2) = bndy_alpha_filt
        ldu_filt_x_C(N,2) = 1.0D0
        ldu_filt_x_D(N,2) = bndy_alpha_filt
        ldu_filt_x_E(N,2) = 0.0D0
       End Do
      endif

      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_filt_x_A(N,Mx-1) = 0.0D0
        ldu_filt_x_B(N,Mx-1) = bndy_alpha_filt
        ldu_filt_x_C(N,Mx-1) = 1.0D0
        ldu_filt_x_D(N,Mx-1) = bndy_alpha_filt
        ldu_filt_x_E(N,Mx-1) = 0.0D0
       End Do
      endif

      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ldu_filt_y_A(N,2) = 0.0D0
        ldu_filt_y_B(N,2) = bndy_alpha_filt
        ldu_filt_y_C(N,2) = 1.0D0
        ldu_filt_y_D(N,2) = bndy_alpha_filt
        ldu_filt_y_E(N,2) = 0.0D0
       End Do
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_filt_y_A(N,My-1) = 0.0D0
        ldu_filt_y_B(N,My-1) = bndy_alpha_filt
        ldu_filt_y_C(N,My-1) = 1.0D0
        ldu_filt_y_D(N,My-1) = bndy_alpha_filt
        ldu_filt_y_E(N,My-1) = 0.0D0
       End Do
      endif

      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ldu_filt_z_A(N,2) = 0.0D0
        ldu_filt_z_B(N,2) = bndy_alpha_filt
        ldu_filt_z_C(N,2) = 1.0D0
        ldu_filt_z_D(N,2) = bndy_alpha_filt
        ldu_filt_z_E(N,2) = 0.0D0
       End Do
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_filt_z_A(N,Mz-1) = 0.0D0
        ldu_filt_z_B(N,Mz-1) = bndy_alpha_filt
        ldu_filt_z_C(N,Mz-1) = 1.0D0
        ldu_filt_z_D(N,Mz-1) = bndy_alpha_filt
        ldu_filt_z_E(N,Mz-1) = 0.0D0
       End Do
      endif
...
*    c = (1 / 8) * (-1 + 2 * bndy_alpha_filt)
      ...
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ldu_filt_x_A(N,3) = 0.0D0
        ldu_filt_x_B(N,3) = bndy_alpha_filt
        ldu_filt_x_C(N,3) = 1.0D0
        ldu_filt_x_D(N,3) = bndy_alpha_filt
        ldu_filt_x_E(N,3) = 0.0D0
       End Do
      endif

      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_filt_x_A(N,Mx-2) = 0.0D0
        ldu_filt_x_B(N,Mx-2) = bndy_alpha_filt
        ldu_filt_x_C(N,Mx-2) = 1.0D0
        ldu_filt_x_D(N,Mx-2) = bndy_alpha_filt
        ldu_filt_x_E(N,Mx-2) = 0.0D0
       End Do
      endif

      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ldu_filt_y_A(N,3)     = 0.0D0
        ldu_filt_y_B(N,3)     = bndy_alpha_filt
        ldu_filt_y_C(N,3)     = 1.0D0
        ldu_filt_y_D(N,3)     = bndy_alpha_filt
        ldu_filt_y_E(N,3)     = 0.0D0
       End Do
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_filt_y_A(N,My-2)     = 0.0D0
        ldu_filt_y_B(N,My-2)     = bndy_alpha_filt
        ldu_filt_y_C(N,My-2)     = 1.0D0
        ldu_filt_y_D(N,My-2)     = bndy_alpha_filt
        ldu_filt_y_E(N,My-2)     = 0.0D0
       End Do 
      endif

      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ldu_filt_z_A(N,3)     = 0.0D0
        ldu_filt_z_B(N,3)     = bndy_alpha_filt
        ldu_filt_z_C(N,3)     = 1.0D0
        ldu_filt_z_D(N,3)     = bndy_alpha_filt
        ldu_filt_z_E(N,3)     = 0.0D0
       End Do
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_filt_z_A(N,Mz-2)     = 0.0D0
        ldu_filt_z_B(N,Mz-2)     = bndy_alpha_filt
        ldu_filt_z_C(N,Mz-2)     = 1.0D0
        ldu_filt_z_D(N,Mz-2)     = bndy_alpha_filt
        ldu_filt_z_E(N,Mz-2)     = 0.0D0
       End Do
      endif
...
*    d = (1 / 32) * (1  - 2  * alpha_filt4 + 2  * beta_filt4)
      ...
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ldu_filt_x_A(N,4)  =  beta_filt4 
        ldu_filt_x_B(N,4)  = alpha_filt4
        ldu_filt_x_C(N,4)  =       1.0D0
        ldu_filt_x_D(N,4)  = alpha_filt4
        ldu_filt_x_E(N,4)  =  beta_filt4
       End Do
      endif

      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_filt_x_A(N,Mx-3)  =  beta_filt4
        ldu_filt_x_B(N,Mx-3)  = alpha_filt4
        ldu_filt_x_C(N,Mx-3)  =       1.0D0
        ldu_filt_x_D(N,Mx-3)  = alpha_filt4
        ldu_filt_x_E(N,Mx-3)  =  beta_filt4
       End Do
      endif

      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ldu_filt_y_A(N,4)  =  beta_filt4
        ldu_filt_y_B(N,4)  = alpha_filt4
        ldu_filt_y_C(N,4)  =       1.0D0
        ldu_filt_y_D(N,4)  = alpha_filt4
        ldu_filt_y_E(N,4)  =  beta_filt4
       End Do
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_filt_y_A(N,My-3)  =  beta_filt4
        ldu_filt_y_B(N,My-3)  = alpha_filt4
        ldu_filt_y_C(N,My-3)  =       1.0D0
        ldu_filt_y_D(N,My-3)  = alpha_filt4
        ldu_filt_y_E(N,My-3)  =  beta_filt4
       End Do
      endif

      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ldu_filt_z_A(N,4)  =  beta_filt4
        ldu_filt_z_B(N,4)  = alpha_filt4
        ldu_filt_z_C(N,4)  =       1.0D0
        ldu_filt_z_D(N,4)  = alpha_filt4
        ldu_filt_z_E(N,4)  =  beta_filt4
       End Do
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_filt_z_A(N,Mz-3)  =  beta_filt4
        ldu_filt_z_B(N,Mz-3)  = alpha_filt4
        ldu_filt_z_C(N,Mz-3)  =       1.0D0
        ldu_filt_z_D(N,Mz-3)  = alpha_filt4
        ldu_filt_z_E(N,Mz-3)  =  beta_filt4
       End Do
      endif
...
*  Wait to recieve planes
      ...
      Do J = 1, My
        Do K = 1, Mz
          ...
          if(xrank .EQ. 0)then
           W(N,1)    = bndy_a1_closure1_filt * F(J,K,1)
     .               + bndy_a2_closure1_filt * F(J,K,2)
     .               + bndy_a3_closure1_filt * F(J,K,3)
     .               + bndy_a4_closure1_filt * F(J,K,4)
     .               + bndy_a5_closure1_filt * F(J,K,5)

           W(N,2)    = bndy_a1_closure2_filt * F(J,K,1)
     .               + bndy_a2_closure2_filt * F(J,K,2)
     .               + bndy_a3_closure2_filt * F(J,K,3)
     .               + bndy_a4_closure2_filt * F(J,K,4)
     .               + bndy_a5_closure2_filt * F(J,K,5)

           W(N,3)    = bndy_a2_closure3_filt * F(J,K,5)
     .               + bndy_a1_closure3_filt * F(J,K,4)
     .               + bndy_a0_closure3_filt * F(J,K,3)
     .               + bndy_a1_closure3_filt * F(J,K,2)
     .               + bndy_a2_closure3_filt * F(J,K,1)

           W(N,4)    = bndy_a3_closure4_filt * F(J,K,7)
     .               + bndy_a2_closure4_filt * F(J,K,6)
     .               + bndy_a1_closure4_filt * F(J,K,5)
     .               + bndy_a0_closure4_filt * F(J,K,4)
     .               + bndy_a1_closure4_filt * F(J,K,3)
     .               + bndy_a2_closure4_filt * F(J,K,2)
     .               + bndy_a3_closure4_filt * F(J,K,1)
          else
...
*  Solve the matrix system to obtain the derivative dF
      Call pentadiagonal(ldu_filt_x_A, ldu_filt_x_B,
     .                   ldu_filt_x_C, ldu_filt_x_D,
     .                   ldu_filt_x_E, W,
...
*  Wait to recieve planes
      ...
      Do I = 1, Mx
        Do K = 1, Mz
          ...
          if(yrank .EQ. 0)then
           W(N,1) = bndy_a1_closure1_filt * F(1,K,I)
     .            + bndy_a2_closure1_filt * F(2,K,I)
     .            + bndy_a3_closure1_filt * F(3,K,I)
     .            + bndy_a4_closure1_filt * F(4,K,I)
     .            + bndy_a5_closure1_filt * F(5,K,I)

           W(N,2) = bndy_a1_closure2_filt * F(1,K,I)
     .            + bndy_a2_closure2_filt * F(2,K,I)
     .            + bndy_a3_closure2_filt * F(3,K,I)
     .            + bndy_a4_closure2_filt * F(4,K,I)
     .            + bndy_a5_closure2_filt * F(5,K,I)

           W(N,3) = bndy_a2_closure3_filt * F(5,K,I)
     .            + bndy_a1_closure3_filt * F(4,K,I)
     .            + bndy_a0_closure3_filt * F(3,K,I)
     .            + bndy_a1_closure3_filt * F(2,K,I)
     .            + bndy_a2_closure3_filt * F(1,K,I)

           W(N,4) = bndy_a3_closure4_filt * F(7,K,I)
     .            + bndy_a2_closure4_filt * F(6,K,I)
     .            + bndy_a1_closure4_filt * F(5,K,I)
     .            + bndy_a0_closure4_filt * F(4,K,I)
     .            + bndy_a1_closure4_filt * F(3,K,I)
     .            + bndy_a2_closure4_filt * F(2,K,I)
     .            + bndy_a3_closure4_filt * F(1,K,I)
          else
...
*  Solve the matrix system to obtain the derivative dF
      Call pentadiagonal(ldu_filt_y_A, ldu_filt_y_B,
     .                   ldu_filt_y_C, ldu_filt_y_D,
     .                   ldu_filt_y_E, W,
     ...
     .                 + a0_filt4 * F(J,K,I)
      ...
      Do I = 1, Mx
        Do J = 1, My
          ...
          if(zrank .EQ. 0)then
           W(N,1) = bndy_a1_closure1_filt * F(J,1,I)
     .            + bndy_a2_closure1_filt * F(J,2,I)
     .            + bndy_a3_closure1_filt * F(J,3,I)
     .            + bndy_a4_closure1_filt * F(J,4,I)
     .            + bndy_a5_closure1_filt * F(J,5,I)

           W(N,2) = bndy_a1_closure2_filt * F(J,1,I)
     .            + bndy_a2_closure2_filt * F(J,2,I)
     .            + bndy_a3_closure2_filt * F(J,3,I)
     .            + bndy_a4_closure2_filt * F(J,4,I)
     .            + bndy_a5_closure2_filt * F(J,5,I)

           W(N,3) = bndy_a2_closure3_filt * F(J,5,I)
     .            + bndy_a1_closure3_filt * F(J,4,I)
     .            + bndy_a0_closure3_filt * F(J,3,I)
     .            + bndy_a1_closure3_filt * F(J,2,I)
     .            + bndy_a2_closure3_filt * F(J,1,I)

           W(N,4) = bndy_a3_closure4_filt * F(J,7,I)
     .            + bndy_a2_closure4_filt * F(J,6,I)
     .            + bndy_a1_closure4_filt * F(J,5,I)
     .            + bndy_a0_closure4_filt * F(J,4,I)
     .            + bndy_a1_closure4_filt * F(J,3,I)
     .            + bndy_a2_closure4_filt * F(J,2,I)
     .            + bndy_a3_closure4_filt * F(J,1,I)
          else
...
* Symmetry BC at entrance boundary
      Do J = 1, My
        Do K = 1, Mz
            if(xrank .EQ. 0)then
             Fg(J,K,1) =  a4_filt_gauss * ( 2D0 * F(J,K,5) )
     ,                  + a3_filt_gauss * ( 2D0 * F(J,K,4) )
     .                  + a2_filt_gauss * ( 2D0 * F(J,K,3) )
     .                  + a1_filt_gauss * ( 2D0 * F(J,K,2) )
     .                  + a0_filt_gauss *   F(J,K,1)

             Fg(J,K,2) =  a4_filt_gauss * ( F(J,K,4) + F(J,K,6) )
     ,                  + a3_filt_gauss * ( F(J,K,3) + F(J,K,5) )
     .                  + a2_filt_gauss * ( F(J,K,2) + F(J,K,4) )
     .                  + a1_filt_gauss * ( F(J,K,1) + F(J,K,3) )
     .                  + a0_filt_gauss *   F(J,K,2)

             Fg(J,K,3) =  a4_filt_gauss * ( F(J,K,3) + F(J,K,7) )
     ,                  + a3_filt_gauss * ( F(J,K,2) + F(J,K,6) )
     .                  + a2_filt_gauss * ( F(J,K,1) + F(J,K,5) )
     .                  + a1_filt_gauss * ( F(J,K,2) + F(J,K,4) )
     .                  + a0_filt_gauss *   F(J,K,3)

             Fg(J,K,4) =  a4_filt_gauss * ( F(J,K,2) + F(J,K,8) )
     ,                  + a3_filt_gauss * ( F(J,K,1) + F(J,K,7) )
     .                  + a2_filt_gauss * ( F(J,K,2) + F(J,K,6) )
     .                  + a1_filt_gauss * ( F(J,K,3) + F(J,K,5) )
...
* Symmetry BC at exit boundary
      Do J = 1, My
        Do K = 1, Mz
          if(xrank .EQ. Px-1)then
           Fg(J,K,Mx) = a4_filt_gauss * ( 2D0 * F(J,K,Mx-4) )
     ,                + a3_filt_gauss * ( 2D0 * F(J,K,Mx-3) )
     .                + a2_filt_gauss * ( 2D0 * F(J,K,Mx-2) )
     .                + a1_filt_gauss * ( 2D0 * F(J,K,Mx-1) )
     .                + a0_filt_gauss *   F(J,K,Mx)

           Fg(J,K,Mx-1) = a4_filt_gauss * ( F(J,K,Mx-3) + F(J,K,Mx-5) )
     ,                  + a3_filt_gauss * ( F(J,K,Mx-2) + F(J,K,Mx-4) )
     .                  + a2_filt_gauss * ( F(J,K,Mx-1) + F(J,K,Mx-3) )
     .                  + a1_filt_gauss * ( F(J,K,Mx)   + F(J,K,Mx-2) )
     .                  + a0_filt_gauss *   F(J,K,Mx-1)

           Fg(J,K,Mx-2) = a4_filt_gauss * ( F(J,K,Mx-2) + F(J,K,Mx-6) )
     ,                  + a3_filt_gauss * ( F(J,K,Mx-1) + F(J,K,Mx-5) )
     .                  + a2_filt_gauss * ( F(J,K,Mx)   + F(J,K,Mx-4) )
     .                  + a1_filt_gauss * ( F(J,K,Mx-1) + F(J,K,Mx-3) )
     .                  + a0_filt_gauss *   F(J,K,Mx-2)

           Fg(J,K,Mx-3) = a4_filt_gauss * ( F(J,K,Mx-1) + F(J,K,Mx-7) )
...
*  Wait to recieve planes
      ...
      Do I = 1, Mx
        Do K = 1, Mz
          if(yrank .EQ. 0)then
           Fg(1,K,I) =  a4_filt_gauss * ( 2D0 * F(5,K,I) )
     ,                + a3_filt_gauss * ( 2D0 * F(4,K,I) )
     .                + a2_filt_gauss * ( 2D0 * F(3,K,I) )
     .                + a1_filt_gauss * ( 2D0 * F(2,K,I) )
     .                + a0_filt_gauss *   F(1,K,I)

           Fg(2,K,I) =  a4_filt_gauss * ( F(4,K,I) + F(6,K,I) )
     ,                + a3_filt_gauss * ( F(3,K,I) + F(5,K,I) )
     .                + a2_filt_gauss * ( F(2,K,I) + F(4,K,I) )
     .                + a1_filt_gauss * ( F(1,K,I) + F(3,K,I) )
     .                + a0_filt_gauss *   F(2,K,I)

           Fg(3,K,I) =  a4_filt_gauss * ( F(3,K,I) + F(7,K,I) )
     ,                + a3_filt_gauss * ( F(2,K,I) + F(6,K,I) )
     .                + a2_filt_gauss * ( F(1,K,I) + F(5,K,I) )
     .                + a1_filt_gauss * ( F(2,K,I) + F(4,K,I) )
     .                + a0_filt_gauss *   F(3,K,I)

           Fg(4,K,I) =  a4_filt_gauss * ( F(2,K,I) + F(8,K,I) )
     ,                + a3_filt_gauss * ( F(1,K,I) + F(7,K,I) )
     .                + a2_filt_gauss * ( F(2,K,I) + F(6,K,I) )
     .                + a1_filt_gauss * ( F(3,K,I) + F(5,K,I) )
...
* Symmetry BC at exit boundary
      Do I = 1, Mx
        Do K = 1, Mz
          if(yrank .EQ. Py-1)then
           Fg(My,K,I) = a4_filt_gauss * ( 2D0 * F(My-4,K,I) )
     ,                + a3_filt_gauss * ( 2D0 * F(My-3,K,I) )
     .                + a2_filt_gauss * ( 2D0 * F(My-2,K,I) )
     .                + a1_filt_gauss * ( 2D0 * F(My-1,K,I) )
     .                + a0_filt_gauss *   F(My,K,I)

           Fg(My-1,K,I) = a4_filt_gauss * ( F(My-3,K,I) + F(My-5,K,I) )
     ,                  + a3_filt_gauss * ( F(My-2,K,I) + F(My-4,K,I) )
     .                  + a2_filt_gauss * ( F(My-1,K,I) + F(My-3,K,I) )
     .                  + a1_filt_gauss * ( F(My,K,I)   + F(My-2,K,I) )
     .                  + a0_filt_gauss *   F(My-1,K,I)

           Fg(My-2,K,I) = a4_filt_gauss * ( F(My-2,K,I) + F(My-6,K,I) )
     ,                  + a3_filt_gauss * ( F(My-1,K,I) + F(My-5,K,I) )
     .                  + a2_filt_gauss * ( F(My,K,I)   + F(My-4,K,I) )
     .                  + a1_filt_gauss * ( F(My-1,K,I) + F(My-3,K,I) )
     .                  + a0_filt_gauss *   F(My-2,K,I)

           Fg(My-3,K,I) = a4_filt_gauss * ( F(My-1,K,I) + F(My-7,K,I) )
...
*  Wait to recieve last 3 planes
      ...
      Do I = 1, Mx
        Do J = 1, My
          if(zrank .EQ. 0)then
           Fg(J,1,I) =  a4_filt_gauss * ( 2D0 * F(J,5,I) )
     ,                + a3_filt_gauss * ( 2D0 * F(J,4,I) )
     .                + a2_filt_gauss * ( 2D0 * F(J,3,I) )
     .                + a1_filt_gauss * ( 2D0 * F(J,2,I) )
     .                + a0_filt_gauss *   F(J,1,I)

           Fg(J,2,I) =  a4_filt_gauss * ( F(J,4,I) + F(J,6,I) )
     ,                + a3_filt_gauss * ( F(J,3,I) + F(J,5,I) )
     .                + a2_filt_gauss * ( F(J,2,I) + F(J,4,I) )
     .                + a1_filt_gauss * ( F(J,1,I) + F(J,3,I) )
     .                + a0_filt_gauss *   F(J,2,I)

           Fg(J,3,I) =  a4_filt_gauss * ( F(J,3,I) + F(J,7,I) )
     ,                + a3_filt_gauss * ( F(J,2,I) + F(J,6,I) )
     .                + a2_filt_gauss * ( F(J,1,I) + F(J,5,I) )
     .                + a1_filt_gauss * ( F(J,2,I) + F(J,4,I) )
     .                + a0_filt_gauss *   F(J,3,I)

           Fg(J,4,I) =  a4_filt_gauss * ( F(J,2,I) + F(J,8,I) )
     ,                + a3_filt_gauss * ( F(J,1,I) + F(J,7,I) )
     .                + a2_filt_gauss * ( F(J,2,I) + F(J,6,I) )
     .                + a1_filt_gauss * ( F(J,3,I) + F(J,5,I) )
     ...
     .                 + a0_filt_gauss *   F(J,4,I)
      ...
      Do I = 1, Mx
        Do J = 1, My
          if(zrank .EQ. Pz-1)then
           Fg(J,Mz,I) = a4_filt_gauss * ( 2D0 * F(J,Mz-4,I) )
     ,                + a3_filt_gauss * ( 2D0 * F(J,Mz-3,I) )
     .                + a2_filt_gauss * ( 2D0 * F(J,Mz-2,I) )
     .                + a1_filt_gauss * ( 2D0 * F(J,Mz-1,I) )
     .                + a0_filt_gauss *   F(J,Mz,I)

           Fg(J,Mz-1,I) = a4_filt_gauss * ( F(J,Mz-3,I) + F(J,Mz-5,I) )
     ,                  + a3_filt_gauss * ( F(J,Mz-2,I) + F(J,Mz-4,I) )
     .                  + a2_filt_gauss * ( F(J,Mz-1,I) + F(J,Mz-3,I) )
     .                  + a1_filt_gauss * ( F(J,Mz,I)   + F(J,Mz-2,I) )
     .                  + a0_filt_gauss *   F(J,Mz-1,I)

           Fg(J,Mz-2,I) = a4_filt_gauss * ( F(J,Mz-2,I) + F(J,Mz-6,I) )
     ,                  + a3_filt_gauss * ( F(J,Mz-1,I) + F(J,Mz-5,I) )
     .                  + a2_filt_gauss * ( F(J,Mz,I)   + F(J,Mz-4,I) )
     .                  + a1_filt_gauss * ( F(J,Mz-1,I) + F(J,Mz-3,I) )
     .                  + a0_filt_gauss *   F(J,Mz-2,I)

           Fg(J,Mz-3,I) = a4_filt_gauss * ( F(J,Mz-1,I) + F(J,Mz-7,I) )
