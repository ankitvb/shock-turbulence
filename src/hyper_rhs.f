...
*     d t             d x                   d x               3         d x      d y     d z
     ...
     .   + (beta_hyper(J,K,I) - (2D0/3D0)*visc_hyper(J,K,I))*dila(J,K,I)
      ...
      Call DFDX(Flux, dFx, 0, 1.0D0)   
      Call DFDX(FF, dEx, 0, 1.0D0)
...
*     d t             d y                 d y     d x
      ...
      Call DFDY(Flux, dFy, 0, 1.0D0)
      Call DFDY(FF,   dEy, 0, 1.0D0)
...
*     d t             d z                 d z     d x
      ...
      Call DFDZ(Flux, dFz, 0, 1.0D0)
      Call DFDZ(FF,   dEz, 0, 1.0D0)
