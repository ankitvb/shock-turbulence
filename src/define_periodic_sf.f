...
*  Rank 0 processor reads input parameters
      If (rank .EQ. 0) Then
         open(unit=in_unit, file='cit.input.1')
...
*  Flow parameters
     ...
     .               ierr)
      Call MPI_BCAST(gamma,      1, MPI_REAL8,   0, MPI_COMM_WORLD, 
     .               ierr)
     ...
     .               ierr)
      Call MPI_BCAST(part_param, 1, MPI_INTEGER, 0, MPI_COMM_WORLD,
     .               ierr)
...
*  Locals
     ...
     .     STATUS="UNKNOWN", POSITION="APPEND")
      ...
      Write(out_unit,15) 'part_param = ', part_param
      Write(out_unit,*)
