...
*   beta =   6.6633190123881123 E-02
      ...
      Do N = 1,LotX
       Do I = 1, Mx
        ldu_x_asym_A1(N,I) =  beta1_pade6
        ldu_x_asym_B1(N,I) = alpha1_pade6
        ldu_x_asym_C1(N,I) =        1.0D0
        ldu_x_asym_D1(N,I) = alpha1_pade6
        ldu_x_asym_E1(N,I) =  beta1_pade6
       End Do
      End Do

      Do N = 1,LotY
       Do J = 1, My
        ldu_y_asym_A1(N,J) =  beta1_pade6
        ldu_y_asym_B1(N,J) = alpha1_pade6
        ldu_y_asym_C1(N,J) =        1.0D0
        ldu_y_asym_D1(N,J) = alpha1_pade6
        ldu_y_asym_E1(N,J) =  beta1_pade6
       End Do
      End Do

      Do N = 1,LotZ
       Do K = 1, Mz
        ldu_z_asym_A1(N,K) =  beta1_pade6
        ldu_z_asym_B1(N,K) = alpha1_pade6
        ldu_z_asym_C1(N,K) =        1.0D0
        ldu_z_asym_D1(N,K) = alpha1_pade6
        ldu_z_asym_E1(N,K) =  beta1_pade6
       End Do
      End Do
...
*                      h     2                   2
      ...
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ...
        ldu_x_asym_B1(N,1) = 0.0D0
        ldu_x_asym_C1(N,1) = 1.0D0
        ldu_x_asym_D1(N,1) = 2D0 * alpha1_pade6
        ldu_x_asym_E1(N,1) = 2D0 * beta1_pade6
       End Do
      endif

      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_x_asym_A1(N,Mx) = 0.0D0
        ldu_x_asym_B1(N,Mx) = 2.0D0
        ldu_x_asym_C1(N,Mx) = 1.0D0
        ldu_x_asym_D1(N,Mx) = 0.0D0
        ldu_x_asym_E1(N,Mx) = 0.0D0
       End Do
      endif
      ...
      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ...
        ldu_y_asym_B1(N,1) = 0.0D0
        ldu_y_asym_C1(N,1) = 1.0D0
        ldu_y_asym_D1(N,1) = 2D0 * alpha1_pade6
        ldu_y_asym_E1(N,1) = 2D0 * beta1_pade6
       End Do
      endif
 
      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_y_asym_A1(N,My) = 0.0D0
        ldu_y_asym_B1(N,My) = 2.0D0
        ldu_y_asym_C1(N,My) = 1.0D0
        ldu_y_asym_D1(N,My) = 0.0D0
        ldu_y_asym_E1(N,My) = 0.0D0
       End Do
      endif
      ...
      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ...
        ldu_z_asym_B1(N,1) = 0.0D0
        ldu_z_asym_C1(N,1) = 1.0D0
        ldu_z_asym_D1(N,1) = 2D0 * alpha1_pade6
        ldu_z_asym_E1(N,1) = 2D0 * beta1_pade6
       End Do
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_z_asym_A1(N,Mz) = 0.0D0
        ldu_z_asym_B1(N,Mz) = 2.0D0
        ldu_z_asym_C1(N,Mz) = 1.0D0
        ldu_z_asym_D1(N,Mz) = 0.0D0
        ldu_z_asym_E1(N,Mz) = 0.0D0
       End Do
      endif
...
*                                        18
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ldu_x_asym_A1(N,2) = 0.0D0
        ldu_x_asym_B1(N,2) = alpha1_pade6
        ldu_x_asym_C1(N,2) = 1.0D0 + beta1_pade6
        ldu_x_asym_D1(N,2) = alpha1_pade6
        ldu_x_asym_E1(N,2) = beta1_pade6
       End Do
      endif
      ...
      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_x_asym_A1(N,Mx-1) = 0.0D0
        ldu_x_asym_B1(N,Mx-1) = 1.0D0 / 2.0D0
        ldu_x_asym_C1(N,Mx-1) = 1.0D0
        ldu_x_asym_D1(N,Mx-1) = 1.0D0 / 6.0D0
        ldu_x_asym_E1(N,Mx-1) = 0.0D0
       End Do
      endif
      ...
      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ldu_y_asym_A1(N,2) = 0.0D0
        ldu_y_asym_B1(N,2) = alpha1_pade6 
        ldu_y_asym_C1(N,2) = 1.0D0 + beta1_pade6
        ldu_y_asym_D1(N,2) = alpha1_pade6
        ldu_y_asym_E1(N,2) = beta1_pade6
       End Do
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_y_asym_A1(N,My-1) = 0.0D0
        ldu_y_asym_B1(N,My-1) = 1.0D0 / 2.0D0
        ldu_y_asym_C1(N,My-1) = 1.0D0
        ldu_y_asym_D1(N,My-1) = 1.0D0 / 6.0D0
        ldu_y_asym_E1(N,My-1) = 0.0D0
       End Do
      endif

      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ldu_z_asym_A1(N,2) = 0.0D0
        ldu_z_asym_B1(N,2) = alpha1_pade6 
        ldu_z_asym_C1(N,2) = 1.0D0 + beta1_pade6
        ldu_z_asym_D1(N,2) = alpha1_pade6
        ldu_z_asym_E1(N,2) = beta1_pade6
       End Do
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_z_asym_A1(N,Mz-1) = 0.0D0
        ldu_z_asym_B1(N,Mz-1) = 1.0D0 / 2.0D0
        ldu_z_asym_C1(N,Mz-1) = 1.0D0
        ldu_z_asym_D1(N,Mz-1) = 1.0D0 / 6.0D0
        ldu_z_asym_E1(N,Mz-1) = 0.0D0
       End Do
      endif

*  The third node is part of antisymmetric BC
*  Third to last node is sixth order accurate
*
*                        
*  beta * f'(1) + alpha * f'(2) + f'(3) + alpha * f'(4) + beta * f'(5)
*                        
...
*                                        9
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ldu_x_asym_A1(N,3) = beta1_pade6
        ldu_x_asym_B1(N,3) = alpha1_pade6
        ldu_x_asym_C1(N,3) = 1.0D0
        ldu_x_asym_D1(N,3) = alpha1_pade6
        ldu_x_asym_E1(N,3) = beta1_pade6
       End Do
      endif

      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_x_asym_A1(N,Mx-2) = 0.0D0
        ldu_x_asym_B1(N,Mx-2) = 1.0D0 / 3.0D0
        ldu_x_asym_C1(N,Mx-2) = 1.0D0
        ldu_x_asym_D1(N,Mx-2) = 1.0D0 / 3.0D0
        ldu_x_asym_E1(N,Mx-2) = 0.0D0
       End Do
      endif

      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ldu_y_asym_A1(N,3) = beta1_pade6
        ldu_y_asym_B1(N,3) = alpha1_pade6
        ldu_y_asym_C1(N,3) = 1.0D0
        ldu_y_asym_D1(N,3) = alpha1_pade6
        ldu_y_asym_E1(N,3) = beta1_pade6
       End Do
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_y_asym_A1(N,My-2) = 0.0D0
        ldu_y_asym_B1(N,My-2) = 1.0D0 / 3.0D0
        ldu_y_asym_C1(N,My-2) = 1.0D0
        ldu_y_asym_D1(N,My-2) = 1.0D0 / 3.0D0
        ldu_y_asym_E1(N,My-2) = 0.0D0
       End Do
      endif

      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ldu_z_asym_A1(N,3) = beta1_pade6
        ldu_z_asym_B1(N,3) = alpha1_pade6
        ldu_z_asym_C1(N,3) = 1.0D0
        ldu_z_asym_D1(N,3) = alpha1_pade6
        ldu_z_asym_E1(N,3) = beta1_pade6
       End Do
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_z_asym_A1(N,Mz-2) = 0.0D0
        ldu_z_asym_B1(N,Mz-2) = 1.0D0 / 3.0D0
        ldu_z_asym_C1(N,Mz-2) = 1.0D0
        ldu_z_asym_D1(N,Mz-2) = 1.0D0 / 3.0D0
        ldu_z_asym_E1(N,Mz-2) = 0.0D0
       End Do
      endif
...
*   beta =   3.8325242145930416 E-02
      ...
      Do N = 1,LotX
       Do I = 1, Mx
        ldu_x_asym_A2(N,I) =  beta2_pade6
        ldu_x_asym_B2(N,I) = alpha2_pade6
        ldu_x_asym_C2(N,I) =        1.0D0
        ldu_x_asym_D2(N,I) = alpha2_pade6
        ldu_x_asym_E2(N,I) =  beta2_pade6
       End Do
      End Do

      Do N = 1,LotY
       Do J = 1, My
        ldu_y_asym_A2(N,J) =  beta2_pade6
        ldu_y_asym_B2(N,J) = alpha2_pade6
        ldu_y_asym_C2(N,J) =        1.0D0
        ldu_y_asym_D2(N,J) = alpha2_pade6
        ldu_y_asym_E2(N,J) =  beta2_pade6
       End Do
      End Do

      Do N = 1,LotZ
       Do K = 1, Mz
        ldu_z_asym_A2(N,K) =  beta2_pade6
        ldu_z_asym_B2(N,K) = alpha2_pade6
        ldu_z_asym_C2(N,K) =        1.0D0
        ldu_z_asym_D2(N,K) = alpha2_pade6
        ldu_z_asym_E2(N,K) =  beta2_pade6
       End Do
      End Do
...
*                               - f(N-3) ]
      ...
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ...
        ldu_x_asym_B2(N,1) = 0.0D0
        ldu_x_asym_C2(N,1) = 1.0D0
        ldu_x_asym_D2(N,1) = 0.0D0
        ldu_x_asym_E2(N,1) = 0.0D0
       End Do
      endif

      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_x_asym_A2(N,Mx) = 0.0D0
        ldu_x_asym_B2(N,Mx) = 1.1D1
        ldu_x_asym_C2(N,Mx) = 1.0D0
        ldu_x_asym_D2(N,Mx) = 0.0D0
        ldu_x_asym_E2(N,Mx) = 0.0D0
       End Do
      endif
      ...
      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ...
        ldu_y_asym_B2(N,1) = 0.0D0
        ldu_y_asym_C2(N,1) = 1.0D0
        ldu_y_asym_D2(N,1) = 0.0D0
        ldu_y_asym_E2(N,1) = 0.0D0
       End Do
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_y_asym_A2(N,My) = 0.0D0
        ldu_y_asym_B2(N,My) = 1.1D1
        ldu_y_asym_C2(N,My) = 1.0D0
        ldu_y_asym_D2(N,My) = 0.0D0
        ldu_y_asym_E2(N,My) = 0.0D0
       End Do
      endif
      ...
      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ...
        ldu_z_asym_B2(N,1) = 0.0D0
        ldu_z_asym_C2(N,1) = 1.0D0
        ldu_z_asym_D2(N,1) = 0.0D0
        ldu_z_asym_E2(N,1) = 0.0D0
       End Do
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_z_asym_A2(N,Mz) = 0.0D0
        ldu_z_asym_B2(N,Mz) = 1.1D1
        ldu_z_asym_C2(N,Mz) = 1.0D0
        ldu_z_asym_D2(N,Mz) = 0.0D0
        ldu_z_asym_E2(N,Mz) = 0.0D0
       End Do
      endif
...
*                                           80
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ldu_x_asym_A2(N,2) =   0.0D0
        ldu_x_asym_B2(N,2) =   alpha2_pade6
        ldu_x_asym_C2(N,2) =   1.0D0 - beta2_pade6
        ldu_x_asym_D2(N,2) =   alpha2_pade6
        ldu_x_asym_E2(N,2) =   beta2_pade6
       End Do
      endif
      ...
      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_x_asym_A2(N,Mx-1) =   0.0D0
        ldu_x_asym_B2(N,Mx-1) = - 7.0D0 / 2.0D1
        ldu_x_asym_C2(N,Mx-1) =   1.0D0
        ldu_x_asym_D2(N,Mx-1) =   1.0D-1
        ldu_x_asym_E2(N,Mx-1) =   0.0D0
       End Do
      endif

      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ldu_y_asym_A2(N,2) =   0.0D0
        ldu_y_asym_B2(N,2) =   alpha2_pade6
        ldu_y_asym_C2(N,2) =   1.0D0 - beta2_pade6
        ldu_y_asym_D2(N,2) =   alpha2_pade6
        ldu_y_asym_E2(N,2) =   beta2_pade6
       End Do
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_y_asym_A2(N,My-1) =   0.0D0
        ldu_y_asym_B2(N,My-1) = - 7.0D0 / 2.0D1
        ldu_y_asym_C2(N,My-1) =   1.0D0
        ldu_y_asym_D2(N,My-1) =   1.0D-1
        ldu_y_asym_E2(N,My-1) =   0.0D0
       End Do
      endif

      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ldu_z_asym_A2(N,2) =   0.0D0
        ldu_z_asym_B2(N,2) =   alpha2_pade6
        ldu_z_asym_C2(N,2) =   1.0D0 - beta2_pade6
        ldu_z_asym_D2(N,2) =   alpha2_pade6
        ldu_z_asym_E2(N,2) =   beta2_pade6
       End Do
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_z_asym_A2(N,Mz-1) =   0.0D0
        ldu_z_asym_B2(N,Mz-1) = - 7.0D0 / 2.0D1
        ldu_z_asym_C2(N,Mz-1) =   1.0D0
        ldu_z_asym_D2(N,Mz-1) =   1.0D-1
        ldu_z_asym_E2(N,Mz-1) =   0.0D0
       End Do
      endif

*  The third node is part of antisymmetric BC and third to last node is sixth order accurate
*
*                     
*   alpha2 * f"(2) + f"(3) + alpha2 * f"(4) + beta2 * f"(5)
*                    
*
*                                  f(6) - 2 f(3) - f(2)      f(5) - 2 f(3)      f(4) - 2 f(3) + f(2)
*                             = c2 -------------------- + b2 ------------- + a2 --------------------
*                                         9 h^2                  4 h^2                  h^2
*
*   2                      2
...
*                               11              h^2
      ...
      if(xrank .EQ. 0)then
       Do N = 1,LotX
        ldu_x_asym_A2(N,3) = 0.0D0
        ldu_x_asym_B2(N,3) = alpha2_pade6
        ldu_x_asym_C2(N,3) = 1.0D0
        ldu_x_asym_D2(N,3) = alpha2_pade6
        ldu_x_asym_E2(N,3) = beta2_pade6
       End Do
      endif

      if(xrank .EQ. Px-1)then
       Do N = 1,LotX
        ldu_x_asym_A2(N,Mx-2) = 0.0D0
        ldu_x_asym_B2(N,Mx-2) = 2.0D0 / 1.1D1
        ldu_x_asym_C2(N,Mx-2) = 1.0D0
        ldu_x_asym_D2(N,Mx-2) = 2.0D0 / 1.1D1
        ldu_x_asym_E2(N,Mx-2) = 0.0D0
       End Do
      endif

      if(yrank .EQ. 0)then
       Do N = 1,LotY
        ldu_y_asym_A2(N,3) = 0.0D0
        ldu_y_asym_B2(N,3) = alpha2_pade6
        ldu_y_asym_C2(N,3) = 1.0D0
        ldu_y_asym_D2(N,3) = alpha2_pade6
        ldu_y_asym_E2(N,3) = beta2_pade6
       End Do
      endif

      if(yrank .EQ. Py-1)then
       Do N = 1,LotY
        ldu_y_asym_A2(N,My-2) = 0.0D0
        ldu_y_asym_B2(N,My-2) = 2.0D0 / 1.1D1
        ldu_y_asym_C2(N,My-2) = 1.0D0
        ldu_y_asym_D2(N,My-2) = 2.0D0 / 1.1D1
        ldu_y_asym_E2(N,My-2) = 0.0D0
       End Do
      endif

      if(zrank .EQ. 0)then
       Do N = 1,LotZ
        ldu_z_asym_A2(N,3) = 0.0D0
        ldu_z_asym_B2(N,3) = alpha2_pade6
        ldu_z_asym_C2(N,3) = 1.0D0
        ldu_z_asym_D2(N,3) = alpha2_pade6
        ldu_z_asym_E2(N,3) = beta2_pade6
       End Do
      endif

      if(zrank .EQ. Pz-1)then
       Do N = 1,LotZ
        ldu_z_asym_A2(N,Mz-2) = 0.0D0
        ldu_z_asym_B2(N,Mz-2) = 2.0D0 / 1.1D1
        ldu_z_asym_C2(N,Mz-2) = 1.0D0
        ldu_z_asym_D2(N,Mz-2) = 2.0D0 / 1.1D1
        ldu_z_asym_E2(N,Mz-2) = 0.0D0
       End Do
      endif
...
*  Wait to recieve planes
      ...
      Do J = 1, My
        Do K = 1, Mz
          ...
          if(xrank .EQ. 0)then
           W(N,1) = fac * (c1_pade6 * ( F(J,K,4) + F(J,K,4) ) 
     .                   + b1_pade6 * ( F(J,K,3) + F(J,K,3) )
...
*  Solve the matrix system to obtain the derivative dF
      Call pentadiagonal(ldu_x_asym_A1, ldu_x_asym_B1, ldu_x_asym_C1,
     .                   ldu_x_asym_D1, ldu_x_asym_E1, W,
...
*  Solve the matrix system to obtain the derivative dF
      Call pentadiagonal(ldu_x_asym_A2, ldu_x_asym_B2, ldu_x_asym_C2,
     .                   ldu_x_asym_D2, ldu_x_asym_E2, W,
     .                   Mx, LotX, 0, MPI_X_COMM)
...
*  Wait to recieve planes
      ...
      Do I = 1, Mx
        Do K = 1, Mz
          ...
          if(yrank .EQ. 0)then
           W(N,1) = fac * (c1_pade6 * ( F(4,K,I) + F(4,K,I) )
     .                  + b1_pade6 * ( F(3,K,I) + F(3,K,I) )
...
*  Solve the matrix system to obtain the derivative dF
      Call pentadiagonal(ldu_y_asym_A1, ldu_y_asym_B1, ldu_y_asym_C1,
     .                   ldu_y_asym_D1, ldu_y_asym_E1, W,
...
*  Solve the matrix system to obtain the derivative dF
      Call pentadiagonal(ldu_y_asym_A2, ldu_y_asym_B2, ldu_y_asym_C2,
     .                   ldu_y_asym_D2, ldu_y_asym_E2, W,
     .                   My, LotY, 0, MPI_Y_COMM)
...
*  Wait to recieve last 3 planes
      ...
      Do I = 1, Mx
        Do J = 1, My
          ...
          if(zrank .EQ. 0)then
           W(N,1) = fac * (c1_pade6 * ( F(J,4,I) + F(J,4,I) )
     .                   + b1_pade6 * ( F(J,3,I) + F(J,3,I) )
...
*  Solve the matrix system to obtain the derivative dF
      Call pentadiagonal(ldu_z_asym_A1, ldu_z_asym_B1, ldu_z_asym_C1,
     .                   ldu_z_asym_D1, ldu_z_asym_E1, W,
...
*  Solve the matrix system to obtain the derivative dF
      Call pentadiagonal(ldu_z_asym_A2, ldu_z_asym_B2, ldu_z_asym_C2,
     .                   ldu_z_asym_D2, ldu_z_asym_E2, W,
     .                   Mz, LotZ, 0, MPI_Z_COMM)
