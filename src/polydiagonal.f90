subroutine polydiagonal(nd,A,R,n,lot,nper,b)

  implicit none
  
  Integer, intent(in) :: n,lot,nd,nper
  Real*8, intent(inout), dimension(lot,n,-nd:nd) :: A
  Real*8, intent(inout), dimension(lot,n)        :: R
  Real*8, intent(inout), dimension(lot,n,nd)     :: b
...
subroutine polydiagonal_serial(nd,A,R,n,lot)
  ...
  Real*8, intent(inout), dimension(lot,n,-nd:nd) :: A
  Real*8, intent(inout), dimension(lot,n)        :: R
  Real*8, dimension(lot) :: const,pivot
  Integer :: i,j,k
