...
*  Code up terms involving x-derivatives
      Call RHS_x(Ux, Qrhs, Y) 

*  Code up terms involving y- and z-derivatives
      Call RHS_yz(Q, Ux, Qrhs, Y)
...
*   d t          d x
      ...
      Call DFDX_asym(Flux, Qconvx(1,1,1,4), 1, -1.0D0)
...
*      d t             d x
      ...
      Call DFDX_asym(Flux, Qconvx(1,1,1,5), 1, -1.0D0)
...
*      d t             2  d x                
      ...
      Call DFDX_sym(Flux, Qconvx(1,1,1,1), 1, -5.0D-1)

*  d (rho u_x)         d P
*  ----------- = ... - ---
*      d t             d x

      Call DFDX_sym(P, Qconvx(1,1,1,1), 1, -1.0D0)
...
*      d t             2 d x                   
      ...
      Call DFDX_asym(Flux, Qconvx(1,1,1,2), 1, -5.0D-1)
...
*      d t             2 d x                  
      ...
      Call DFDX_asym(Flux, Qconvx(1,1,1,3), 1, -5.0D-1)
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            ...
            Q(J,K,I,5)  = ((fac1 * T(J,K,I)) ** vis_exp )
     .             * ( Re1_inv * Y(J,K,I,1) 
     .             + Re2_inv * sqrt(epsilon)*(1D0-Y(J,K,I,1)) )/
     .            (Y(J,K,I,1) + sqrt(epsilon)*(1D0-Y(J,K,I,1)))
            Flux(J,K,I) = ((fac1 * T(J,K,I)) ** fac2    ) 
     .           * ( Re1_inv * Y(J,K,I,1)
     .           + Re2_inv * sqrt(epsilon)*(1D0-Y(J,K,I,1)) )/
     .           (Y(J,K,I,1) + sqrt(epsilon)*(1D0-Y(J,K,I,1)))
     .           * vis_exp * fac1
...
*      d t             2       d y
      ...
      Call DFDY_asym(Flux, Qconvy(1,1,1,1), 1, -5.0D-1)
...
*      d t             2       d y
      ...
      Call DFDY_sym(Flux, Qconvy(1,1,1,2), 1, -5.0D-1)

*  d (rho u_y)         d P
*  ----------- = ... - ---
*      d t             d y

      Call DFDY_sym(P, Qconvy(1,1,1,2), 1, -1.0D0)
...
*      d t             2       d y
      ...
      Call DFDY_asym(Flux, Qconvy(1,1,1,3), 1, -5.0D-1)
...
*      d t                     d y
      ...
      Call DFDY_asym(Flux, Qconvy(1,1,1,5), 1, -1.0D0)
...
*      d t             2        d z
      ...
      Call DFDZ_asym(Flux, Qconvz(1,1,1,1), 1, -5.0D-1)
...
*      d t             2        d z
      ...
      Call DFDZ_asym(Flux, Qconvz(1,1,1,2), 1, -5.0D-1)
...
*      d t             2        d z
      ...
      Call DFDZ_sym(Flux, Qconvz(1,1,1,3), 1, -5.0D-1)

*  d (rho u_z)         d P
*  ----------- = ... - ---
*      d t             d z

      Call DFDZ_sym(P, Qconvz(1,1,1,3), 1, -1.0D0)
...
*      d t                     d z
      ...
      Call DFDZ_asym(Flux, Qconvz(1,1,1,5), 1, -1.0D0)
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            ...
            vis(J,K,I) = ((fac1 * T(J,K,I)) ** vis_exp )
     .            * ( Re1_inv * Y(J,K,I,1)
     .            + Re2_inv * sqrt(epsilon)*(1D0-Y(J,K,I,1)) )/
     .            (Y(J,K,I,1) + sqrt(epsilon)*(1D0-Y(J,K,I,1)))
            Udz(J,K,I) = ((fac1 * T(J,K,I)) ** fac2    )
     .                  * ( Re1_inv * Y(J,K,I,1)
     .            + Re2_inv * sqrt(epsilon)*(1D0-Y(J,K,I,1)) )/
     .          (Y(J,K,I,1) + sqrt(epsilon)*(1D0-Y(J,K,I,1)))
     .          * vis_exp * fac1 
...
*  Q3 = rho u_z
      ...
      if(Re.GT.0)then
        ...
        Qrhs = Qrhs + Qconvx + Qconvy + Qconvz
      endif
