...
*  Subroutine: E2S                                                     *
*                                                                      *
*  Function:   Converts Q5 from E to S for evolving entropy instead    *
*              of total energy                                         *
************************************************************************
      Subroutine E2S(Q)
      ...
      Real*8 Q(My,Mz,Mx,5)
      Real*8 P(My,Mz,Mx), Vs(My,Mz,Mx), S(My,Mz,Mx)
      Real*8 fac1
     ...
     .                           + Q(J,K,I,2) * Q(J,K,I,2)
     .                           + Q(J,K,I,3) * Q(J,K,I,3) ) )
            S(J,K,I)   = P(J,K,I)/(Q(J,K,I,4)**fac1)
            Q(J,K,I,5) = S(J,K,I)
          End Do
        End Do
      End Do
...
************************************************************************
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            Vs(J,K,I)  = 1.0D0 / Q(J,K,I,4)
            P(J,K,I)   = Q(J,K,I,5)*(Q(J,K,I,4)**fac1)
            Q(J,K,I,5) = P(J,K,I)/fac1 + 5.0D-1*Vs(J,K,I)*
     .                   ( Q(J,K,I,1)*Q(J,K,I,1)  
     .                   + Q(J,K,I,2)*Q(J,K,I,2)
     .                   + Q(J,K,I,3)*Q(J,K,I,3) ) 
          End Do
...
c        Call E2S(Q)        ! For evolving entropy
        Call RHS(Q, dQ)
        Call Hyper_RHS(Q, dQ)
c        Call bc_RHS(Q, dQ, time+c1_rk4(K)*Tstep) ! Noh
...
c        if(Step .GT. 5)then    ! for nonperiodic isotropic turbulence
          Call Compact_filter(Q, Qf, 5)
          Q = Qf   ! Setting field to filtered value
c        endif
        
c        Call S2E(Q)          ! For evolving Entropy
        Call Fix_Pressure(Q) ! Shock-turbulence, Noh
...
c         Call E2S(Q)          ! For evolving entropy
         Call RHS(Q, dQ)
         Call Hyper_RHS(Q, dQ)
c         Call bc_RHS(Q, dQ, time+c2_rk4(K)*Tstep) ! Noh
