...
*  Locals
      ...
      Qrhs = 0D0; Qconvx = 0D0; Qconvy = 0D0; Qconvz = 0D0
      Qvisc = 0D0
...
*   d t          d x
      ...
      Call DFDX(Flux, Qconvx(1,1,1,4), 1, -1.0D0)

*  Flux = (rho e_t + P) u_x
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            Flux(J,K,I) = (Q(J,K,I,5) + P(J,K,I)) * FF(J,K,I)
          End Do
        End Do
      End Do
...
*      d t             d x
      ...
      Call DFDX(Flux, Qconvx(1,1,1,5), 1, -1.0D0)
...
*      d t             2  d x                
      ...
      Call DFDX(Flux, Qconvx(1,1,1,1), 1, -5.0D-1)

*  d (rho u_x)         d P
*  ----------- = ... - ---
*      d t             d x

      Call DFDX(P, Qconvx(1,1,1,1), 1, -1.0D0)
...
*      d t             2 d x                   
      ...
      Call DFDX(Flux, Qconvx(1,1,1,2), 1, -5.0D-1)
...
*      d t             2 d x                  
      ...
      Call DFDX(Flux, Qconvx(1,1,1,3), 1, -5.0D-1)

*       d (rho u_x)
*  FF = -----------
*           d x

      Call DFDX(Q(1,1,1,1), FF, 0, 1.0D0)
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            ...
            Qconvx(J,K,I,1) = Qconvx(J,K,I,1) + fac2 * Q(J,K,I,1)
            Qconvx(J,K,I,2) = Qconvx(J,K,I,2) + fac2 * Q(J,K,I,2)
            Qconvx(J,K,I,3) = Qconvx(J,K,I,3) + fac2 * Q(J,K,I,3)
          End Do
        End Do
      End Do
...
*      d t             Pr   Re  d x^2     Re  d T      d x
      ...
      Do I = 1,Mx
        Do J = 1,My
         ...
         Qvisc(J,K,I,5) = Qvisc(J,K,I,5) + fac1*(Q(J,K,I,5) * dF(J,K,I)
...
*          d x^2
      ...
      Call D2FDX2(Q(1,1,1,1), Flux, dF, 1)
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            ...
            Qvisc(J,K,I,1) = Qvisc(J,K,I,1) + fac2
            Qvisc(J,K,I,5) = Qvisc(J,K,I,5) + Q(J,K,I,1) * fac2
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            ...
            Qvisc(J,K,I,2) = Qvisc(J,K,I,2) + fac2
            Qvisc(J,K,I,5) = Qvisc(J,K,I,5) + Q(J,K,I,2) * fac2
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            ...
            Qvisc(J,K,I,3) = Qvisc(J,K,I,3) + fac2
            Qvisc(J,K,I,5) = Qvisc(J,K,I,5) + Q(J,K,I,3) * fac2
...
*           d y
      ...
      Call DFDY(Q(1,1,1,2), dF, 0, 1.0D0)
...
*   d t              d y
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            Qconvy(J,K,I,4) = Qconvy(J,K,I,4) - dF(J,K,I)
          End Do
        End Do
      End Do
...
*      d t             2       d y
      ...
      Call DFDY(Flux, Qconvy(1,1,1,1), 1, -5.0D-1)
...
*      d t             2       d y
      ...
      Call DFDY(Flux, Qconvy(1,1,1,2), 1, -5.0D-1)

*  d (rho u_y)         d P
*  ----------- = ... - ---
*      d t             d y

      Call DFDY(P, Qconvy(1,1,1,2), 1, -1.0D0)
...
*      d t             2       d y
      ...
      Call DFDY(Flux, Qconvy(1,1,1,3), 1, -5.0D-1)
...
*  Flux = (rho e_t + P) u_y
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
           Flux(J,K,I) = ( Q(J,K,I,5) + P(J,K,I) ) * Ux(J,K,I,5)
          End Do
        End Do
      End Do

*  d (rho e_t)         d (rho e_t + P) u_y
*  ----------- = ... - -------------------
*      d t                     d y

      Call DFDY(Flux, Qconvy(1,1,1,5), 1, -1.0D0)

*         d (rho u_z)
*  dFz =  -----------
*            d z

      Call DFDZ(Q(1,1,1,3), dFz, 0, 1.0D0)
...
*   d t              d z
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            Qconvz(J,K,I,4) = Qconvz(J,K,I,4) - dFz(J,K,I)
          End Do
        End Do
      End Do
...
*      d t             2        d z
      ...
      Call DFDZ(Flux, Qconvz(1,1,1,1), 1, -5.0D-1)
...
*      d t             2        d z
      ...
      Call DFDZ(Flux, Qconvz(1,1,1,2), 1, -5.0D-1)
...
*      d t             2        d z
      ...
      Call DFDZ(Flux, Qconvz(1,1,1,3), 1, -5.0D-1)

*  d (rho u_z)         d P
*  ----------- = ... - ---
*      d t             d z

      Call DFDZ(P, Qconvz(1,1,1,3), 1, -1.0D0)
...
*  d (rho e_t)         d (rho e_t + P) u_z
*  ----------- = ... - -------------------
*      d t                     d z

      Call DFDZ(Flux, Qconvz(1,1,1,5), 1, -1.0D0)
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            ...
            Qconvy(J,K,I,1) = Qconvy(J,K,I,1) + fac2 * Q(J,K,I,1)
            Qconvy(J,K,I,2) = Qconvy(J,K,I,2) + fac2 * Q(J,K,I,2)
            Qconvy(J,K,I,3) = Qconvy(J,K,I,3) + fac2 * Q(J,K,I,3)
          End Do
        End Do
      End Do
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            ...
            Qconvz(J,K,I,1) = Qconvz(J,K,I,1) + fac2 * Q(J,K,I,1)
            Qconvz(J,K,I,2) = Qconvz(J,K,I,2) + fac2 * Q(J,K,I,2)
            Qconvz(J,K,I,3) = Qconvz(J,K,I,3) + fac2 * Q(J,K,I,3)
          End Do
        End Do
      End Do
...
*        d y^2
      ...
      Call D2FDY2(T, Tdy, Ux(1,1,1,5), 1)
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            ...
            Qvisc(J,K,I,5) = Qvisc(J,K,I,5) + fac2 * ( vis(J,K,I) *
...
*         d y
      ...
      Call DFDY(Q(1,1,1,4), Udz, 0, 1.0D0)
...
*         d y^2
      ...
      Call D2FDY2(Q(1,1,1,1), P, Ux(1,1,1,5), 1)
...
*          d y^2
      ...
      Call D2FDY2(Q(1,1,1,2), Flux, dF, 1)
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            ...
            Qconvy(J,K,I,1) = Qconvy(J,K,I,1) + fac2 *    P(J,K,I)
            Qconvy(J,K,I,2) = Qconvy(J,K,I,2) + fac2 * Flux(J,K,I)
            Qconvy(J,K,I,3) = Qconvy(J,K,I,3) + fac2 *  Udz(J,K,I)
          End Do
        End Do
      End Do
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            ...
            Qconvz(J,K,I,1) = Qconvz(J,K,I,1) + fac2 * Udx(J,K,I)
            Qconvz(J,K,I,2) = Qconvz(J,K,I,2) + fac2 * Udy(J,K,I)
            Qconvz(J,K,I,3) = Qconvz(J,K,I,3) + fac2 * dFz(J,K,I)
          End Do
        End Do
      End Do
      ...
      Do I = 1,Mx
        Do J = 1,My
          Do K = 1,Mz
            ...
            Qvisc(J,K,I,1) = Qvisc(J,K,I,1) + fac_X
            Qvisc(J,K,I,2) = Qvisc(J,K,I,2) + fac_Y
            Qvisc(J,K,I,3) = Qvisc(J,K,I,3) + fac_Z
            Qvisc(J,K,I,5) = Qvisc(J,K,I,5) + Q(J,K,I,1) * fac_X
     .                                      + Q(J,K,I,2) * fac_Y
     .                                      + Q(J,K,I,3) * fac_Z
          End Do
        End Do
...
*        d y    d z
      ...
      Call DFDY(dF, Ux(1,1,1,5), 0, 1.0D0)
...
*          d z^2
      ...
      Call D2FDZ2(Q(1,1,1,2), Flux, Ux(1,1,1,5), 0)
...
*        d y    d x
      ...
      Call DFDY(Ux(1,1,1,1), Ux(1,1,1,4), 0, 1.0D0)

*         d    d u_x
*  Ux5 = --- ( ----- )
*        d z    d x

      Call DFDZ(Ux(1,1,1,1), Ux(1,1,1,5), 0, 1.0D0)

*         d    d u_y
*  Tdy = --- ( ----- )
*        d y    d x

      Call DFDY(Ux(1,1,1,2), Tdy, 0, 1.0D0)

*         d    d u_z
*  Tdz = --- ( ----- )
*        d z    d x

      Call DFDZ(Ux(1,1,1,3), Tdz, 0, 1.0D0)

*         d    d u_y
*   T  = --- ( ----- )
*        d y    d z

      Call DFDY(Flux, T, 0, 1.0D0)
...
*  Q3 = rho u_z
      ...
      Qrhs = Qrhs + Qconvx + Qconvy + Qconvz + Qvisc
